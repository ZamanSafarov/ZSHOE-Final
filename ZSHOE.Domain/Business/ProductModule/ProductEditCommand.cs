...
using ZSHOE.Domain.Migrations;
using static Microsoft.EntityFrameworkCore.DbLoggerCategory.Database;
using ZSHOE.Domain.Models.Entities;
using Product = ZSHOE.Domain.Models.Entities.Product;
...
namespace ZSHOE.Domain.Business.ProductModule
{
    public class ProductEditCommand : IRequest<Product>
    {
        ...
        public class ProductEditCommandHandler : IRequestHandler<ProductEditCommand, Product>
        {
            ...
            public ProductEditCommandHandler(ZSHOEDbContext db, IHostEnvironment env, IActionContextAccessor ctx)
            {
                this.db = db;
                this.env = env;
                this.ctx = ctx;
            ...
            public async Task<Product> Handle(ProductEditCommand request, CancellationToken cancellationToken)
            {
                try
                {
                    ...
                    if (request.ColorId != data.ColorId || request.SizeId != data.SizeId)
                    {
