#pragma checksum "D:\Coding\Final-Project\ZSHOE-Solution\ZSHOE\Views\Shared\_BasketScriptsPartial.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "775e7bff81084e07d62d8889a8c078de67fb4fdf"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"775e7bff81084e07d62d8889a8c078de67fb4fdf", @"/Views/Shared/_BasketScriptsPartial.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
            WriteLiteral("\n\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "775e7bff81084e07d62d8889a8c078de67fb4fdf5097", async() => {
            }
            );
...
#nullable disable
   ...
   ");
            WriteLiteral(@"                             } else {
                                ...
                                $(element).closest('tr.cartItem').remove();
    ...
    function changeQuantity(event, element) {
        ...
        $.processId = setTimeout(function () {
            ...
            $.ajax({
                url: `");
#nullable restore
#line 94 "D:\Coding\Final-Project\ZSHOE-Solution\ZSHOE\Views\Shared\_BasketScriptsPartial.cshtml"
...
#nullable disable
            WriteLiteral(@"`,
                ...
                success: function (response) {
                    ...
                    if (response.error == false) {
                        ...
                        //if(response.value?.quanti");
            WriteLiteral(@"ty == null){
    ...
    fun");
            WriteLiteral(@"ction addToFavorites(productId) {
    ...
    function addToBasket(e) {
        ...
        $.ajax({
            url: `");
#nullable restore
#line 182 "D:\Coding\Final-Project\ZSHOE-Solution\ZSHOE\Views\Shared\_BasketScriptsPartial.cshtml"
...
#nullable disable
            ...
            success: function (response) {
                if (response.error == false) {
                    ...
                    //                <li>
                    //      ");
            WriteLiteral(@"              <h6 class='single-product-name'>
                    ...
                    //                           onclick='removeFromBasket(this,""${response.value.product.");
            WriteLiteral(@"product.name}"");return;'>
